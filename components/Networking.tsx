    ...
    <div className="sticky flex space-x-4">
      <Link href="https://github.com/howiejayz" target="_blank">
        <Image
          ...
          src="/github.svg"
          alt="GitHub"
          className="transition duration-500 ease-in-out hover:invert dark:invert dark:hover:filter-none"
        />
      </Link>
      <Link href="https://linkedin.com/in/junhao-zh" target="_blank">
        <Image
          ...
          src="/linkedin.svg"
          alt="LinkedIn"
          className="icon transition duration-500 ease-in-out hover:filter-none"
        />
      </Link>
